...
public class instantiatePlanesHC : MonoBehaviour {
	...
	public int[,] possiblePositions=new int[,] {{-400,1000}, {40,0} };
	public int[,] dependendAirplanPosition=new int[,] {{40,0}, {-40,0} };
	...
	void makePlane() {
		...
		planeInstance.transform.position = new Vector2 (possiblePositions [1, 1], possiblePositions [1, 2]);
		...
		planeInstance.GetComponent<Rigidbody2D>().velocity = new Vector2(-velocityModule,0);
	//	if (sign > 0) {
	//		velocityAngle = 180;
